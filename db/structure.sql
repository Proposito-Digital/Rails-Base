...
--
-- Name: index_api_keys_on_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_api_keys_on_deleted_at ON public.api_keys USING btree (deleted_at);
...
--
-- Name: index_user_roles_on_deleted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_roles_on_deleted_at ON public.user_roles USING btree (deleted_at);
...
--
-- Name: index_users_on_current_role_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_users_on_current_role_id ON public.users USING btree (current_role_id);
...
--
-- Name: users fk_rails_83d9817008; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.users
    ADD CONSTRAINT fk_rails_83d9817008 FOREIGN KEY (current_role_id) REFERENCES public.user_roles(id);
